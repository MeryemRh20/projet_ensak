...
$pdo = $connexion->getConnexion(); // Récupération de l'objet PDO
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nom) || empty($prenom) || empty($email1) || empty($email2) || empty($password1) || empty($password2)) {
...
<div class="b-example-divider">
 ...
 <img src="image/businessman.svg" alt="Avatar" class="avatar" width="80" height="80">
    </div>
